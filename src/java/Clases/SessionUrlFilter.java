...
public class SessionUrlFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        String[] urlPermitidaSinSesion = new String[]{
            "faces/index.xhtml",
            "faces/paginas/login.xhtml",            
            "faces/paginas/pru.xhtml",
            "faces/paginas/Gallery.xhtml",
            "faces/paginas/frmEvento.xhtml",
            "faces/paginas/frmRegistrados.xhtml",
            "faces/paginas/frmParticipantes.xhtml"
        };
